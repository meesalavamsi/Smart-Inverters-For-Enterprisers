...
async function main() {
  ...
  const products = [
    ...
    {
      name: "Terranova T-I 1150 Gen 1 — Wall Mount",
      model: "TERRA-T1150-G1-WM",
      slug: "terranova-t1150-gen1-wall-mount",
      description: "The Terranova T-I 1150 Gen 1 is a next-generation Lithium Home UPS built for reliable, uninterrupted power backup in homes, offices, shops, schools, and commercial spaces. With built-in LiFePO₄ battery technology, it offers superior safety, longer life, faster charging, zero maintenance, and higher efficiency than conventional lead-acid UPS systems.",
      price: 39000,
      warranty: "5 Years Battery / 2 Years Electronics",
      capacity: "1 kV / 1000 VA",
      batteryType: "Built-in LiFePO₄ Battery",
      features: JSON.stringify([
        "Built-in Lithium Battery — no separate battery purchase required.",
        "LiFePO₄ Battery Technology — safer, longer-lasting, fast-charging, and thermally stable.",
        "UPS & Inverter Dual Mode — UPS mode for sensitive electronics and Inverter mode for household appliances.",
        "Intelligent Battery Management — monitors health, charging, discharging, voltage, and temperature.",
        "Compact & Modern Design — elegant, space-saving, lightweight, and easy to install.",
        "Zero Maintenance — no water filling, no acid checks, and no periodic servicing.",
        "Long Battery Life — more backup cycles and longer reliable service than lead-acid.",
        "Fast Charging — faster recharge for more available backup time.",
        "Environment Friendly — no toxic gases, no acid leakage, and no harmful emissions.",
        "Silent Operation — quiet performance ideal for homes, offices, classrooms, and clinics.",
        "Advanced Safety Protection — overload, short circuit, deep discharge, overcharge, high temperature, and smart charging protection.",
        "Smart Battery Recovery (S-BR) Technology — improved battery efficiency, charging performance, and backup stability.",
        "Ideal for Homes, Apartments, Shops, Offices, Schools, Colleges, Clinics, CCTV, Wi-Fi routers, TVs, fans, and lights."
      ]),
      specifications: JSON.stringify({
        "Model": "T-I 1150 Gen 1",
        "Capacity": "1000 VA / 800 W",
        "Battery Type": "Built-in LiFePO₄ Battery",
        "Battery Energy": "1280 Wh",
        "Battery Chemistry": "Lithium Iron Phosphate (LiFePO₄)",
        "Battery Warranty": "5 Years",
        "Electronics Warranty": "2 Years",
        "Operating Modes": "UPS Mode, Inverter Mode",
        "Technology": "Smart Battery Recovery (S-BR)",
