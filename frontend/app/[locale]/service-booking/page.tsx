...
import { CalendarDays, CheckCircle, Loader2, MessageCircle, Phone, Lock, UserPlus, LogIn, ShieldCheck } from "lucide-react";
import { toast } from "sonner";
import Link from "next/link";
import { bookingsApi } from "@/lib/api";
import { useAuthStore } from "@/lib/store";
import { getWhatsAppUrl, SERVICE_TIMES } from "@/lib/utils";
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {SERVICE_TIMES.map((time) => (
                    ...
                    >
                      <input type="radio" value={time} {...form.register("preferredTime")} className="sr-only" />
                      {time}
                    </label>
                  ))}
                </div>
