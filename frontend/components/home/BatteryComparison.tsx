  ...
  return (
    <section className="py-20 relative overflow-hidden" style={{ background: "linear-gradient(180deg, #050d24 0%, #020818 100%)" }}>
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/4 w-[500px] h-[500px] -translate-y-1/2 rounded-full" style={{ background: "radial-gradient(ellipse, rgba(22,163,74,0.08) 0%, transparent 70%)" }} />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block text-xs font-bold px-4 py-2 rounded-full mb-4 border border-green-500/40 text-green-300"
          ...
          <p className="text-green-300/70 max-w-xl mx-auto">{t("subtitle")}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative rounded-3xl p-7 overflow-hidden border border-green-500/30"
            style={{ background: "linear-gradient(145deg, #0f2855, #0a1f45)", boxShadow: "0 0 40px rgba(22,163,74,0.2)" }}
          >
            <div className="absolute top-0 right-0 w-40 h-40 rounded-full -translate-y-10 translate-x-10" style={{ background: "radial-gradient(circle, rgba(22,163,74,0.2) 0%, transparent 70%)" }} />

            <div className="relative">
              <div className="flex items-center gap-3 mb-6">
                <div className="h-11 w-11 rounded-xl flex items-center justify-center" style={{ background: "rgba(22,163,74,0.3)", border: "1px solid rgba(22,163,74,0.5)" }}>
                  <Zap className="h-5 w-5 text-green-300" />
                </div>
                <div>
                  <h3 className="text-xl font-extrabold text-white">{t("lithiumTitle")}</h3>
                  <p className="text-green-400 text-sm">{t("lithiumSubtitle")}</p>
                </div>
        ...
        >
          {[
            ...
            <div key={labelKey} className="rounded-2xl p-4 text-center border border-green-500/20" style={{ background: "rgba(22,163,74,0.08)" }}>
              <p className="text-2xl font-extrabold" style={{ background: "linear-gradient(135deg,#86efac,#22c55e)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text" }}>{value}</p>
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex items-center justify-center">
            <div className="text-center text-white">
              <div className="h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform backdrop-blur-sm border border-white/30" style={{ background: "rgba(22,163,74,0.5)" }}>
